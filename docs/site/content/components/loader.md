...
{% story-template file="packages/shared/angular/src/lib/components/loader/loader.component.stories.ts" region="usage" /%}
...
```text
Add a loader to the settings page, using @smartsoft001/angular.
```
