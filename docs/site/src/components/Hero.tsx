...
const code = `import { Model, Field, FieldType } from '@smartsoft001/models';
...
const tabs = [
  { name: 'user.model.ts', isActive: true },
  { name: 'app.config.ts', isActive: false },
]
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                ...
                <Button
                  href="https://github.com/emiljuchnikowski/smartsoft001"
                  variant="secondary"
                >
                  View on GitHub
                </Button>
