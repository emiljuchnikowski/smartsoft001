...
describe('trans-domain: CreatorService', () => {
  ...
  describe('create', () => {
    ...
    it('should throw DomainValidationError when config is empty', async () => {
      const asyncFn = async () => {
        await service.create(null as any, mockInternalService, mockPaymentService);
      };
    ...
    it('should throw DomainValidationError when name is missing', async () => {
      ...
      const asyncFn = async () => {
        await service.create(invalidTrans, mockInternalService, mockPaymentService);
      };
  ...
  describe('validation', () => {
    ...
    it('should throw DomainValidationError when system is invalid', async () => {
      const invalidTrans = { ...mockTrans, system: 'invalid-system' as TransSystem };
