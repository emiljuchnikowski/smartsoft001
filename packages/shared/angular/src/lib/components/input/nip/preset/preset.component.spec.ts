...
import { InputNipPresetComponent } from './preset.component';
...
@Component({
  ...
  template: `
    <smart-input-nip-preset
      [options]="options"
      [fieldOptions]="fieldOptions"
      [class]="cssClass"
    ></smart-input-nip-preset>
  `,
  imports: [InputNipPresetComponent],
})
...
describe('@smartsoft001/shared-angular: InputNipPresetComponent', () => {
