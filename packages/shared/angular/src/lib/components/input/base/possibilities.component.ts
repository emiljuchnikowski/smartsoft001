import { ChangeDetectorRef, Directive, Inject, Optional, signal, Signal, Type } from '@angular/core';
...
export abstract class InputPossibilitiesBaseComponent<T> extends InputBaseComponent<T> {
    ...
    protected getPossibilitiesFromProvider(): Signal<{ id: any, text: string }[] | null> {
