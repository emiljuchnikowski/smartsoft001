...
import { InputPhoneNumberPresetComponent } from './preset.component';
...
@Component({
  ...
  template: `
    <smart-input-phone-number-preset
      [options]="options"
      [fieldOptions]="fieldOptions"
      [class]="cssClass"
    ></smart-input-phone-number-preset>
  `,
  imports: [InputPhoneNumberPresetComponent],
})
...
describe('@smartsoft001/shared-angular: InputPhoneNumberPresetComponent', () => {
