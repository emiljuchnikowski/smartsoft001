...
import { InputTextPresetComponent } from './preset.component';
...
@Component({
  ...
  template: `
    <smart-input-text-preset
      [options]="options"
      [fieldOptions]="fieldOptions"
      [class]="cssClass"
    ></smart-input-text-preset>
  `,
  imports: [InputTextPresetComponent],
})
...
function buildOptions(control: UntypedFormControl): InputOptions<TextModel> {
  new UntypedFormGroup({ name: control });
  return {
    control,
    fieldKey: 'name',
    model: new TextModel(),
...
describe('@smartsoft001/shared-angular: InputTextPresetComponent', () => {
