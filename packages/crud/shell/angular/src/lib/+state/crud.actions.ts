...
export const readSuccess = function <T extends IEntity<string>, F>(
  entity: string,
  filter: F,
  result: { data: T[]; totalCount: number; links: any },
): Action & {
  result: { data: T[]; totalCount: number; links: any };
  filter: F;
} {
 ...
 * Clear
 */
export const clear = function (entity: string): Action {
  return {
    type: `[${entity}] Clear`,
  };
};
...
export const exportList = function (
  ...
  format: any,
): Action & { filter: ICrudFilter; format: any } {
  return {
    type: `[${entity}] Export`,
...
export const updatePartialFailure = function <T extends IEntity<string>>(
  ...
  item: Partial<T> & { id: string },
  error: any,
): Action & { item: Partial<T> & { id: string }; error: any } {
  return {
...
export const updatePartialManyFailure = function <T extends IEntity<string>>(
  ...
  items: Partial<T> & { id: string }[],
  error: any,
): Action & { items: Partial<T> & { id: string }[]; error: any } {
  return {
