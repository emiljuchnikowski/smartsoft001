        ...
        <ion-row>
            <ion-col>
                <ion-item-divider>
                    ...
                    @if (value?.length) {
                        <ion-button slot="end" color="danger" (click)="refresh([])"
                                    class="square-button">
                ...
                @for (entry of list(); track entry) {
                    <ion-item>
                        ...
                        <ion-checkbox slot="end" [checked]="entry.isCheck"
                                      (ionChange)="onCheckChange($event.detail.checked, entry)"></ion-checkbox>
                    </ion-item>
                }
            </ion-col>
        </ion-row>
