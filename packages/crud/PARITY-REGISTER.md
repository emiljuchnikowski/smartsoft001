...
- [x] GAP-21 filters panel ✅ Phase 3 (Tailwind header/close/title + scroll list, OnPush; dispatcher comments cleaned) · [x] GAP-22 filters-config chips + remove ✅ Phase 3 (🔴 fixed — Tailwind clickable chip buttons, `onRemoveQuery` reachable again, OnPush) · [ ] GAP-23 group accordion · [ ] GAP-24 group CD deferral
