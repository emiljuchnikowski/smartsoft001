...
- [x] GAP-21 filters panel ✅ Phase 3 (Tailwind header/close/title + scroll list, OnPush; dispatcher comments cleaned) · [ ] GAP-22 filters-config chips + remove · [ ] GAP-23 group accordion · [ ] GAP-24 group CD deferral
